...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_rfstest" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#31c03069#;
   pragma Export (C, u00001, "rfstestB");
   ...
   u00054 : constant Version_32 := 16#4d3a63f3#;
   pragma Export (C, u00054, "resourcefilesystemB");
   u00055 : constant Version_32 := 16#259edc59#;
   pragma Export (C, u00055, "resourcefilesystemS");
   u00056 : constant Version_32 := 16#1358602f#;
   pragma Export (C, u00056, "ada__streamsS");
   u00057 : constant Version_32 := 16#778cb37d#;
   pragma Export (C, u00057, "refcountB");
   u00058 : constant Version_32 := 16#a2af9fb3#;
   pragma Export (C, u00058, "refcountS");
   ...
   u00061 : constant Version_32 := 16#7a48d8b1#;
   pragma Export (C, u00061, "interfaces__c_streamsB");
   u00062 : constant Version_32 := 16#a539be81#;
   pragma Export (C, u00062, "interfaces__c_streamsS");
   u00063 : constant Version_32 := 16#773a2d5d#;
   pragma Export (C, u00063, "system__crtlS");
   u00064 : constant Version_32 := 16#4a803ccf#;
   pragma Export (C, u00064, "system__file_ioB");
   u00065 : constant Version_32 := 16#60d89729#;
   ...
   u00069 : constant Version_32 := 16#225de354#;
   ...
   u00072 : constant Version_32 := 16#f05a3eb1#;
   pragma Export (C, u00072, "interfaces__cS");
   u00073 : constant Version_32 := 16#62120d5e#;
   ...
   u00075 : constant Version_32 := 16#a50435f4#;
   pragma Export (C, u00075, "system__crtl__runtimeS");
   u00076 : constant Version_32 := 16#721198aa#;
   ...
   u00079 : constant Version_32 := 16#da45da00#;
   pragma Export (C, u00079, "system__stringsS");
   u00080 : constant Version_32 := 16#b2907efe#;
   pragma Export (C, u00080, "system__file_control_blockS");
   u00081 : constant Version_32 := 16#6d35da9a#;
   pragma Export (C, u00081, "system__finalization_mastersB");
   u00082 : constant Version_32 := 16#075a3ce8#;
   ...
   u00084 : constant Version_32 := 16#cc430dfe#;
   ...
   u00093 : constant Version_32 := 16#88cd69c1#;
   pragma Export (C, u00093, "system__memoryB");
   u00094 : constant Version_32 := 16#a7242cd1#;
   pragma Export (C, u00094, "system__memoryS");
   u00095 : constant Version_32 := 16#17551a52#;
   pragma Export (C, u00095, "system__storage_pools__subpoolsB");
   u00096 : constant Version_32 := 16#738e4bc9#;
   pragma Export (C, u00096, "system__storage_pools__subpoolsS");
   u00097 : constant Version_32 := 16#3351da79#;
   pragma Export (C, u00097, "basicsB");
   u00098 : constant Version_32 := 16#00770dfa#;
   pragma Export (C, u00098, "basicsS");
   u00099 : constant Version_32 := 16#af50e98f#;
   pragma Export (C, u00099, "ada__stringsS");
   u00100 : constant Version_32 := 16#261c554b#;
   pragma Export (C, u00100, "ada__strings__unboundedB");
   u00101 : constant Version_32 := 16#2bf53506#;
   pragma Export (C, u00101, "ada__strings__unboundedS");
   u00102 : constant Version_32 := 16#86f7ec7f#;
   ...
   u00106 : constant Version_32 := 16#193a50a3#;
   ...
   u00119 : constant Version_32 := 16#dc4bee60#;
   pragma Export (C, u00119, "streamsS");
   u00120 : constant Version_32 := 16#60f82714#;
   pragma Export (C, u00120, "typesS");
   ...
   --  refcount%s
   --  refcount%b
   --  resourcefilesystem%s
   --  resourcefilesystem%b
   --  types%s
   --  streams%s
   --  rfstest%b
