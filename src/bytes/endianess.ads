...
package Endianess is
   ...
   function ToBE(Integer: Integer16) return BigEndianInteger16;
   function ToBE(Integer: Integer32) return BigEndianInteger32;
   function ToBE(Integer: Integer64) return BigEndianInteger64;
   ...
   function ToBE(Cardinal: Cardinal32) return BigEndianCardinal32;

   function From(Cardinal: BigEndianCardinal32) return Cardinal32;
